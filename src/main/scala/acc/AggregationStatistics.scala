...
object AggregationStatistics {
    ...
    val DEFAULT_TIME_BASE_RANGE = Array(new LongRange(1, 3), new LongRange(4, 6),
        new LongRange(7, 9), new LongRange(10, 30), new LongRange(30, 60))
    ...
    def aggregationStatics(sc: SparkContext, rdd: RDD[(String, SessionRecord)],
                           timeRanges: Array[LongRange] = DEFAULT_TIME_BASE_RANGE,
                           pageRanges: Array[LongRange] = DEFAULT_STEP_BASE_RANGE): AggAccVariable = {
        // 自定义
